...
/* - D3DTX Legacy Version 8 games
 * Strong Bad's Cool Game for Attractive People Ep. 1, 2 (TESTED)
*/
...
public class D3DTX_LV8 : ID3DTX
{
    ...
    public string GetDebugInfo(TelltaleToolGame game = TelltaleToolGame.DEFAULT, T3PlatformType platform = T3PlatformType.ePlatform_None)
    {
        ...
        d3dtxInfo += "||||||||||| D3DTX Legacy Version 8 Header |||||||||||" + Environment.NewLine;
