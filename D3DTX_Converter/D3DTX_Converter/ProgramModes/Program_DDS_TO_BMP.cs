...
namespace D3DTX_Converter.ProgramModes
{
    public static class Program_DDS_TO_BMP
    {
        ...
        public static void ConvertBulk(string texPath, string resultPath)
        {
            ...
            textures = IOManagement.FilterFiles(textures, ".dds");
            ...
            for (int i = 0; i < textures.Count; i++)
            {
                ...
                string textureResultPath = resultPath + "/" + textureFileNameOnly + ".bmp"; //add the file name to the resulting folder path, this is where our converted file will be placed
