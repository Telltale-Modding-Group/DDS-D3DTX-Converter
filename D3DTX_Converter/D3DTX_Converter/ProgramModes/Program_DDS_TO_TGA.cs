    ...
    public static class Program_DDS_TO_TGA
    {
        ...
        public static void ConvertBulk(string texPath, string resultPath)
        {
            ...
            for (int i = 0; i < textures.Count; i++)
            {
                ...
                string textureResultPath = resultPath + "/" + textureFileNameOnly + ".tga"; //add the file name to the resulting folder path, this is where our converted file will be placed
