...
namespace D3DTX_TextureConverter.GenericImageConvert
{
    /// <summary>
    ...
    {
        public static void ConvertDDS_To_JPEG(string path, bool removeOriginalFile = false) => ConvertFromDDS_Master(path, ".jpeg", ImageFormat.JPEG, removeOriginalFile);

        public static void ConvertDDS_To_PNG(string path, bool removeOriginalFile = false) => ConvertFromDDS_Master(path, ".png", ImageFormat.PNG, removeOriginalFile);

        public static void ConvertDDS_To_PSD(string path, bool removeOriginalFile = false) => ConvertFromDDS_Master(path, ".psd", ImageFormat.PSD, removeOriginalFile);

        public static void ConvertDDS_To_TGA(string path, bool removeOriginalFile = false) => ConvertFromDDS_Master(path, ".tga", ImageFormat.TARGA, removeOriginalFile);

        public static void ConvertDDS_To_TIFF(string path, bool removeOriginalFile = false) => ConvertFromDDS_Master(path, ".tiff", ImageFormat.TIFF, removeOriginalFile);

        public static void ConvertDDS_To_BMP(string path, bool removeOriginalFile = false) => ConvertFromDDS_Master(path, ".bmp", ImageFormat.BMP, removeOriginalFile);
