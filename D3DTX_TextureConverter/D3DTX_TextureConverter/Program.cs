...
using D3DTX_TextureConverter.ProgramModes;
...
namespace D3DTX_TextureConverter
{
    class Program
    {
        ...
        */
        ...
        public static bool d3dtx_to_dds = true; //.d3dtx ---> .dds

        public static bool dds_to_png = false; //.dds ---> .png
        public static bool dds_to_psd = false; //.dds ---> .psd
        ...
        public static bool psd_to_dds = false; //.psd ---> .dds
        ...
        static void Main(string[] args)
        {
            ...
            if (dds_to_psd) { Program_DDS_TO_PSD.Execute(); return; }
            ...
            if (psd_to_dds) { Program_PSD_TO_DDS.Execute(); return; }
