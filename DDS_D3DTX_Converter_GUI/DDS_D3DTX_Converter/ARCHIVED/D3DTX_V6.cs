 ...
 * In this case, mVersion 6 of d3dtx files was never found in the pc games we've looked at.
 * Presumable it was used internally, until they migrated directly to mVersion 7.
*/
...
namespace D3DTX_Converter.TelltaleD3DTX
{
    ...
    public class D3DTX_V6
    {
        ...
        public uint GetHeaderByteSize()
        {
            ...
            totalSize += (uint)Marshal.SizeOf(mNormalMapFormat); //mNormalMapFormat [4 bytes]
