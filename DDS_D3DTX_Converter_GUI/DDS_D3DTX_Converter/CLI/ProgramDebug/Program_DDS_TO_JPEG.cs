...
namespace D3DTX_Converter.ProgramDebug
{
    public static class Program_DDS_TO_JPEG
    {
        ...
        public static void ConvertTextureFile(string sourceFile, string destinationDirectory, bool fixes_dds_to_generic)
        {
            ...
            string outputTextureFilePath_JPG =
                destinationDirectory + @"\" + textureFileNameOnly + Main_Shared.jpgExtension;
            string outputTextureFilePath_JPEG =
                destinationDirectory + @"\" + textureFileNameOnly + Main_Shared.jpegExtension;
            ...
            if (File.Exists(textureFilePath_JSON))
            {
                ...
                {
                    if (fixes_dds_to_generic)
                        NormalMapProcessing.FromDDS_NormalMapReconstructZ(sourceFile, outputTextureFilePath_JPEG);
                    //     else
