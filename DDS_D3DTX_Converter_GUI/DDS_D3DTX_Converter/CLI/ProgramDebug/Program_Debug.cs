        ...
        */
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
                ...
                if (bulkConvert)
                {
                    Converter_CLI.ConvertBulk(path, resultPath, originalFormat, formatToConvert, (D3DTXConversionType)d3dtxConversionMode);
                }
                else
                {
                    if (originalFormat == "d3dtx")
                    {
                        Converter_CLI.ConvertTextureFromD3DtxToDds(path, resultPath, (D3DTXConversionType)d3dtxConversionMode);
                    }
