...
namespace DDS_D3DTX_Converter
{
    public class Converter
    {
        ...
        public static bool ConvertBulk(string texPath, string resultPath, string oldFileType, string newFileType = "", D3DTXConversionType conversionType = D3DTXConversionType.DEFAULT)
        {
            ...
            for (int i = 0; i < textures.Count; i++)
            {
                ...
                threads[i] = new Thread(() =>
                {
                    try
                    {
                        PerformConversion(mode, name, resultPath, newFileType, conversionType);
                    }
                    catch (Exception)
                    {
        ...
        private static void PerformConversion(short mode, string sourceFilePath, string destinationDirectory, string newFileType, D3DTXConversionType conversionType = D3DTXConversionType.DEFAULT)
        {
            switch (mode)
            {
                case 0:
                ...
                case 1:
                    ...
                    break;
                case 2:
                    ConvertTextureFromDdsToOthers(sourceFilePath, destinationDirectory, newFileType, true);
                    break;
                case 3:
        ...
        public static void ConvertTextureFromDdsToD3Dtx(string? sourceFilePath, string destinationDirectory)
        {
            ...
            if (File.Exists(textureFilePathJson))
            {
                ...
                //get the sections of the dds file (mipmaps, faces, etc.)
                ...
                d3dtxFile.WriteFinalD3DTX(textureResultPathD3Dtx);
            }
            ...
            bool fixes_generic_to_dds)
        {
            ...
            //create the names of the following files
            string textureFileNameWithJSON = Path.Combine(textureFileNameOnly, Main_Shared.jsonExtension);
