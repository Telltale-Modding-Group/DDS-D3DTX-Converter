...
/* - D3DTX Legacy Version 4 games
 * Wallace & Gromit's Grand Adventures Ep. 4 (TESTED)
...
public class D3DTX_LV4
{
    ...
    public D3DTX_LV4(BinaryReader reader, bool showConsole = true)
    {
        bool read = true;
    ...
    public string GetD3DTXInfo(MetaVersion metaVersion = MetaVersion.UNKNOWN)
    {
        ...
        d3dtxInfo += "||||||||||| D3DTX Legacy Version 4 Header |||||||||||" + Environment.NewLine;
