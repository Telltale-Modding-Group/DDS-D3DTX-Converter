...
/* - D3DTX Legacy Version 5 games
 * Wallace & Gromit's Grand Adventures Ep. 1-3 (TESTED)
*/
...
public class D3DTX_LV5
{
    ...
    public D3DTX_LV5(BinaryReader reader, bool showConsole = true)
    {
        bool read = true;
    ...
    public string GetD3DTXInfo(MetaVersion metaVersion = MetaVersion.UNKNOWN)
    {
        ...
        d3dtxInfo += "||||||||||| D3DTX Legacy Version 5 Header |||||||||||" + Environment.NewLine;
