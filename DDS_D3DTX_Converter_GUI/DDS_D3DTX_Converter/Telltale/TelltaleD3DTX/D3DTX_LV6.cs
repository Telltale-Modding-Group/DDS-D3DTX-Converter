...
/* - D3DTX Legacy Version 6 games
 * Strong Bad's Cool Game for Attractive People Ep. 5 (TESTED)
*/
...
public class D3DTX_LV6
{
    ...
    public D3DTX_LV6(BinaryReader reader, bool showConsole = true)
    {
        bool read = true;
    ...
    public string GetD3DTXInfo(MetaVersion metaVersion = MetaVersion.UNKNOWN)
    {
        ...
        d3dtxInfo += "||||||||||| D3DTX Legacy Version 6 Header |||||||||||" + Environment.NewLine;
