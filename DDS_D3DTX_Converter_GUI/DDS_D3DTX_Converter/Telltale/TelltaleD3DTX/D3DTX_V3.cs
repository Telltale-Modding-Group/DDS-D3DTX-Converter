...
namespace D3DTX_Converter.TelltaleD3DTX
{
  ...
  public class D3DTX_V3
  {
    ...
    /// <summary>
    /// [16 bytes for each element] An array containing each pixel region in the texture. //Mip Index -> Datasize -> pitch
    /// </summary>
    ...
    public D3DTX_V3(BinaryReader reader, bool showConsole = false)
    {
      ...
      mPlatformType = EnumPlatformType.GetPlatformType(reader.ReadInt32()); //mPlatform [4 bytes]
    ...
    public void ModifyD3DTX(DDS_Master ddsMaster, DDS_DirectXTexNet_ImageSection[] sections)
    {
      ...
      for (int i = 0; i < mStreamHeader.mRegionCount; i++)
      {
        ...
        {
          mDataSize = (uint)mPixelData[mStreamHeader.mRegionCount - 1 - i].Length,
          mMipCount = 1,
    ...
    public void PrintConsole()
    {
      ...
      Console.WriteLine("D3DTX mPlatform_BlockSize = {0}", mPlatformType_BlockSize);
      Console.WriteLine("D3DTX mPlatform = {0} ({1})", Enum.GetName(typeof(PlatformType), (int)mPlatformType), mPlatformType);
      ...
      Console.WriteLine("D3DTX_v3 mImportScale = {0}", mImportScale);
      ...
      Console.WriteLine("D3DTX mToonRegions_BlockSize = {0}", mToonRegions_BlockSize);
    ...
    public string GetD3DTXInfo()
    {
      ...
      d3dtxInfo += "||||||||||| D3DTX_v3 Header |||||||||||" + Environment.NewLine;
      d3dtxInfo += "D3DTX mVersion = " + mVersion + Environment.NewLine;
      d3dtxInfo += "D3DTX_v3 mSamplerState_BlockSize = " + mSamplerState_BlockSize + Environment.NewLine;
      d3dtxInfo += "D3DTX_v3 mSamplerState = " + mSamplerState + Environment.NewLine;
      d3dtxInfo += "D3DTX mPlatform_BlockSize = " + mPlatformType_BlockSize + Environment.NewLine;
      d3dtxInfo += "D3DTX mPlatform = " + Enum.GetName(typeof(PlatformType), (int)mPlatformType) + " (" + mPlatformType + ")" + Environment.NewLine;
      d3dtxInfo += "D3DTX_v3 mName_BlockSize = " + mName_BlockSize + Environment.NewLine;
      d3dtxInfo += "D3DTX_v3 mName = " + mName + Environment.NewLine;
      d3dtxInfo += "D3DTX_v3 mImportName_BlockSize = " + mImportName_BlockSize + Environment.NewLine;
      d3dtxInfo += "D3DTX_v3 mImportName = " + mImportName + Environment.NewLine;
      d3dtxInfo += "D3DTX_v3 mImportScale = " + mImportScale + Environment.NewLine;
      d3dtxInfo += "D3DTX_v3 mToolProps = " + mToolProps + Environment.NewLine;
      d3dtxInfo += "D3DTX_v3 mNumMipLevels = " + mNumMipLevels + Environment.NewLine;
      d3dtxInfo += "D3DTX_v3 mWidth = " + mWidth + Environment.NewLine;
      d3dtxInfo += "D3DTX_v3 mHeight = " + mHeight + Environment.NewLine;
      ...
      d3dtxInfo += "D3DTX mNormalMapFormat = " + mNormalMapFormat + Environment.NewLine;
      d3dtxInfo += "D3DTX mHDRLightmapScale = " + mHDRLightmapScale + Environment.NewLine;
      d3dtxInfo += "D3DTX_v3 mAlphaMode = " + Enum.GetName(typeof(eTxAlpha), (int)mAlphaMode) + " (" + mAlphaMode + ")" + Environment.NewLine;
      d3dtxInfo += "D3DTX_v3 mColorMode = " + Enum.GetName(typeof(eTxColor), (int)mColorMode) + " (" + mColorMode + ")" + Environment.NewLine;
      d3dtxInfo += "D3DTX_v3 mUVOffset = " + mUVOffset + Environment.NewLine;
      d3dtxInfo += "D3DTX_v3 mUVScale = " + mUVScale + Environment.NewLine;
      d3dtxInfo += "----------- mToonRegions -----------" + Environment.NewLine;
      d3dtxInfo += "D3DTX mToonRegions_BlockSize = " + mToonRegions_BlockSize + Environment.NewLine;
