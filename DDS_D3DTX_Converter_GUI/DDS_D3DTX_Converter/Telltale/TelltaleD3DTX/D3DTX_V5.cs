...
public class D3DTX_V5
{
    ...
    public string GetD3DTXInfo()
    {
        ...
        d3dtxInfo += "||||||||||| D3DTX Version 5 Header |||||||||||" + Environment.NewLine;
        ...
        d3dtxInfo += "mPlatform = " + Enum.GetName(typeof(PlatformType), (int)mPlatform) + " (" + mPlatform + ")" + Environment.NewLine;
        ...
        d3dtxInfo += "mImportSpecularPower = " + mImportSpecularPower + Environment.NewLine;
        ...
        d3dtxInfo += "mSurfaceFormat = " + Enum.GetName(typeof(T3SurfaceFormat), mSurfaceFormat) + " (" + mSurfaceFormat + ")" + Environment.NewLine;
        d3dtxInfo += "mTextureLayout = " + mTextureLayout + Environment.NewLine;
        d3dtxInfo += "mSurfaceGamma = " + mSurfaceGamma + Environment.NewLine;
        d3dtxInfo += "mResourceUsage = " + Enum.GetName(typeof(T3ResourceUsage), mResourceUsage) + " (" + mResourceUsage + ")" + Environment.NewLine;
        ...
        d3dtxInfo += "mAlphaMode = " + Enum.GetName(typeof(eTxAlpha), mAlphaMode) + " (" + mAlphaMode + ")" + Environment.NewLine;
        d3dtxInfo += "mColorMode = " + Enum.GetName(typeof(eTxColor), mColorMode) + " (" + mColorMode + ")" + Environment.NewLine;
