...
namespace D3DTX_Converter.TelltaleD3DTX
{
    ...
    public class D3DTX_V5
    {
        ...
        /// <summary>
        /// D3DTX V5 Header (empty constructor, only used for json deserialization)
        /// </summary>
        public D3DTX_V5() { }
        ...
        public string GetD3DTXInfo()
        {
            ...
            d3dtxInfo += "D3DTX mImportSpecularPower = " + mImportSpecularPower + Environment.NewLine;
            ...
            d3dtxInfo += "D3DTX mSurfaceFormat = " + Enum.GetName(typeof(T3SurfaceFormat), mSurfaceFormat) + " (" + mSurfaceFormat + ")" + Environment.NewLine;
            d3dtxInfo += "D3DTX mTextureLayout = " + mTextureLayout + Environment.NewLine;
            d3dtxInfo += "D3DTX mSurfaceGamma = " + mSurfaceGamma + Environment.NewLine;
            d3dtxInfo += "D3DTX mResourceUsage = " + Enum.GetName(typeof(T3ResourceUsage), mResourceUsage) + " (" + mResourceUsage + ")" + Environment.NewLine;
            d3dtxInfo += "D3DTX mType = " + mType + Environment.NewLine;
            ...
            d3dtxInfo += "D3DTX mAlphaMode = " + Enum.GetName(typeof(eTxAlpha), mAlphaMode) + " (" + mAlphaMode + ")" + Environment.NewLine;
            d3dtxInfo += "D3DTX mColorMode = " + Enum.GetName(typeof(eTxColor), mColorMode) + " (" + mColorMode + ")" + Environment.NewLine;
