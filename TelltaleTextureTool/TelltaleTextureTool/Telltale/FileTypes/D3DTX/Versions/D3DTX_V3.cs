...
public class D3DTX_V3 : ID3DTX
{
  ...
  public string GetDebugInfo(TelltaleToolGame game = TelltaleToolGame.DEFAULT, T3PlatformType platform = T3PlatformType.ePlatform_None)
  {
    ...
    d3dtxInfo += "mPlatformType_BlockSize = " + mPlatform_BlockSize + Environment.NewLine;
    d3dtxInfo += "mPlatformType = " + Enum.GetName(typeof(T3PlatformType), (int)mPlatform) + " (" + mPlatform + ")" + Environment.NewLine;
