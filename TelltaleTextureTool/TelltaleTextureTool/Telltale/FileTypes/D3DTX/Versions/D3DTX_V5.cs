...
public class D3DTX_V5 : ID3DTX
{
    ...
    public string GetDebugInfo(TelltaleToolGame game = TelltaleToolGame.DEFAULT, T3PlatformType platform = T3PlatformType.ePlatform_None)
    {
        ...
        d3dtxInfo += "mAlphaMode = " + Enum.GetName(typeof(T3TextureAlphaMode), mAlphaMode) + " (" + mAlphaMode + ")" + Environment.NewLine;
        d3dtxInfo += "mColorMode = " + Enum.GetName(typeof(T3TextureColor), mColorMode) + " (" + mColorMode + ")" + Environment.NewLine;
